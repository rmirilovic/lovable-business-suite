...
-- Fix get_article_warehouse_card: rename 'MMP izlaz' to 'MMP ulaz storno' for source warehouse
-- and ensure both sides use correct naming
...
BEGIN
  ...
  SELECT * FROM (
    ...
    SELECT
      ...
      'MMP ulaz storno'::TEXT AS document_type,
