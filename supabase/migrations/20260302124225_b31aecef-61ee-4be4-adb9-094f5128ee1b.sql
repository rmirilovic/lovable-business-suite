...
BEGIN
  ...
  -- Get org unit code for 6141 analytics
  ...
  -- Get warehouse code for 9800/9600 analytics (from linked delivery note)
  IF _invoice.source_delivery_note_id IS NOT NULL THEN
    SELECT w.code INTO _warehouse_code
