-- Function to unpost a service purchase invoice
-- Only users with admin access level on the purchase module can execute this
...
BEGIN
  ...
  v_access_level := get_user_access_level(_user_id, 'nabavka.ulazne_fakture_usluge', v_invoice.company_id, NULL);
...
GRANT EXECUTE ON FUNCTION public.unpost_service_purchase_invoice(uuid, uuid) TO authenticated;