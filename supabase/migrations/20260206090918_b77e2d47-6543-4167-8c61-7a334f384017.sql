...
-- Fix post_service_purchase_invoice(_invoice_id, _user_id) to store item-level organizational unit as cost_center_code
...
BEGIN
  ...
  LOOP
    ...
    -- cost center: item org_unit_id first, fallback to invoice org_unit_id
