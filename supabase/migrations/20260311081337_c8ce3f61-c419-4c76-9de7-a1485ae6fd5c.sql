...
-- Update post_invoice to include partner code in partner_info
...
BEGIN
  ...
  _receivable_account := CASE WHEN _is_foreign THEN '2040' ELSE '2040' END;
  ...
  LOOP
    ...
    INSERT INTO journal_entry_items (
      ...
      CASE WHEN _vat_rec.vat_rate = 0 THEN '6100' WHEN _vat_rec.vat_rate = 10 THEN '6100' ELSE '6100' END,
      _item_order,
  ...
  -- Handle advance invoice storno if linked
...
-- Update post_advance_invoice to include partner code in partner_info
