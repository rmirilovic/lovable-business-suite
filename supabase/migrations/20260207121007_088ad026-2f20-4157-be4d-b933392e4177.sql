...
-- Function to get warehouse stock summary (aggregated per article)
...
-- Function to get detailed article warehouse card (movements)
...
DECLARE
  v_avg_cost NUMERIC;
BEGIN
  -- Calculate weighted average cost from all posted receipts
