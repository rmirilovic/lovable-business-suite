...
BEGIN
  ...
  WITH all_movements AS (
    ...
    UNION ALL
    SELECT vs.swap_date, 'Zamena varij. storno'::TEXT, vs.swap_number, ''::TEXT, -vs.quantity, 0::NUMERIC, vs.unit_price, -vs.swap_value, 0::NUMERIC
  ...
  FROM opening o WHERE p_date_from IS NOT NULL AND (o.in_qty <> 0 OR o.out_qty <> 0)
  UNION ALL
  SELECT am.mv_date, am.doc_type, am.doc_number, am.p_name, am.in_qty, am.out_qty, am.u_price, am.deb_val, am.cred_val
  FROM all_movements am
