...
-- Update post_advance_purchase_invoice: add partner code to partner_info
...
-- Update post_goods_purchase_invoice: add partner code to partner_info
...
-- Update post_received_credit_note: add partner code to partner_info
...
-- Update post_service_purchase_invoice: add partner code to partner_info
