...
BEGIN
  ...
  -- Calculate total cost_value for materials (SVK=2,6) = purchase_value + allocated_costs
  ...
  IF v_total_additional_costs > 0 OR v_total_markup > 0 OR v_total_material_cost_value > 0 THEN
    ...
    LOOP
      ...
      -- Debit inventory account with warehouse analytics
      ...
      INSERT INTO journal_entry_items (
        ...
        v_cost.amount, 0, v_calc.calculation_date, v_warehouse_code
      );
