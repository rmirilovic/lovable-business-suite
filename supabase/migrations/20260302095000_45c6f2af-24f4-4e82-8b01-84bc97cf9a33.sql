...
-- Add source_document_id column to track which document created the row
ALTER TABLE popdv_report_detail_rows ADD COLUMN source_document_id uuid;
CREATE INDEX idx_popdv_detail_source_doc ON popdv_report_detail_rows(source_document_id);

-- Fix unpost_invoice to use correct column
