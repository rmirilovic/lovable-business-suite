...
export const appNavigation: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Pregled predatih GP", href: "/proizvodnja/pregled-predatih-gp", moduleCode: "proizvodnja.radni_nalozi" },
      { label: "Proizvodnja GP po šiframa i klasama", href: "/proizvodnja/proizvodnja-po-sif-klasama", moduleCode: "proizvodnja.radni_nalozi" },
      { label: "Dnevni izveštaj proizvodnje", href: "/proizvodnja/dnevni-izvestaj", moduleCode: "proizvodnja.radni_nalozi" },
      { label: "Izveštaj po šefovima smena", href: "/proizvodnja/izvestaj-sefovi-smena", moduleCode: "proizvodnja.radni_nalozi" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Zaključavanje PDV perioda", href: "/racunovodstvo/zakljucavanje-pdv", moduleCode: "racunovodstvo.nalozi" },
      ...
      { label: "Obračun troškova proizvodnje", href: "/racunovodstvo/obracun-proizvodnje", moduleCode: "racunovodstvo.bruto_bilans" },
      { label: "Zatvaranje godine", href: "/racunovodstvo/zatvaranje-godine", moduleCode: "racunovodstvo.nalozi" },
      { label: "Usklađivanje PNC", href: "/racunovodstvo/uskladjivanje-pnc", moduleCode: "racunovodstvo.wac_rekonsilijacija" },
    ],
  },
  {
