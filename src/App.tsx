...
import ProizvodneLinije from "./pages/sifarnici/ProizvodneLinije";
...
import ZakljucniList from "./pages/racunovodstvo/ZakljucniList";
...
import CustomsClearanceEdit from "./pages/nabavka/CustomsClearanceEdit";
...
import StanjePoVarijantama from "./pages/magacin/StanjePoVarijantama";
...
import ZameneVarijanti from "./pages/magacin/ZameneVarijanti";
import VariantSwapEdit from "./pages/magacin/VariantSwapEdit";
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/sifarnici/proizvodne-linije" element={
                <ProtectedRoute>
                  <ProizvodneLinije />
                </ProtectedRoute>
              } />
              ...
              <Route path="/racunovodstvo/stanje-po-tr" element={
                <ProtectedRoute>
                  <StanjePoTR />
                </ProtectedRoute>
              } />
              ...
              <Route path="/racunovodstvo/zakljucni-list" element={
                <ProtectedRoute>
                  <ZakljucniList />
                </ProtectedRoute>
              } />
              ...
              <Route path="/racunovodstvo/zakljucavanje-pdv" element={
                <ProtectedRoute>
                  <ZakljucavanjePdvPerioda />
                </ProtectedRoute>
              } />
              ...
              <Route path="/proizvodnja/dnevni-izvestaj" element={
                <ProtectedRoute>
